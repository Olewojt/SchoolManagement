...
public class SubjectController {
    ...
    @PutMapping("/{subjectName}/remove")
    public SubjectWithClassesDTO removeClassFromSubject(@PathVariable String subjectName,
                                                        @RequestParam String className) {
        return subjectService.removeClassFromSubject(subjectName, className);
    }
}
