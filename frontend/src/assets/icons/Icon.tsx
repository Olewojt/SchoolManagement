    ...
    return (
        <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#FFD6FF" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
...
export const ReportIcon = () => {
    return (
        <svg width="37" height="34" viewBox="0 0 37 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2 32H35M15 32V16H7V32H15ZM15 32H22M15 32V8H22V32M22 32H30V2H22V32Z" stroke="#FFD6FF"
...
export const TasksIcon = () => {
    return (
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M31.4466 17.3712V31.627H2V2.18872H17.0666" stroke="#FFD6FF" stroke-width="3" stroke-linecap="round"
...
export const LogoutIcon = () => {
    return (
        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 26.152V30H2V2H22V6.13604" stroke="#FFD6FF" stroke-width="3" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path d="M18 11L13 16.0035L18 21" stroke="#FFD6FF" stroke-width="3" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path d="M31 16H14" stroke="#FFD6FF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
