    ...
    return (
        <svg width="47" height="48" viewBox="0 0 47 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#FFD6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            <path
...
export const TasksIcon = () => {
    return (
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M31.4466 17.3712V31.627H2V2.18872H17.0666" stroke="#FFD6FF" strokeWidth="3" strokeLinecap="round"
...
export const LogoutIcon = () => {
    return (
        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 26.152V30H2V2H22V6.13604" stroke="#FFD6FF" strokeWidth="3" strokeLinecap="round"
                  strokeLinejoin="round"/>
            <path d="M18 11L13 16.0035L18 21" stroke="#FFD6FF" strokeWidth="3" strokeLinecap="round"
                  strokeLinejoin="round"/>
            <path d="M31 16H14" stroke="#FFD6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
