...
public class ReportController {
    ...
    public String avgGradesReportForStudent(@PathVariable Long userId, @RequestParam List<String> subjectNames) {
       return reportService.avgGradesReportForStudent(userId, subjectNames);
    }
